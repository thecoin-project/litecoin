...
const char * const BITCOIN_CONF_FILENAME = "thecoin.conf";
const char * const BITCOIN_PID_FILENAME = "thecoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Thecoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Thecoin";
#else
    // Unix
    return pathRet / ".thecoin";
#endif
#endif
}
