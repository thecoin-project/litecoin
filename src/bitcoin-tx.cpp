...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s thecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  thecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded thecoin transaction") + "\n" +
              "  thecoin-tx [options] -create [commands]   " + _("Create hex-encoded thecoin transaction") + "\n" +
              "\n";
