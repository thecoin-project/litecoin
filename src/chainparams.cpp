...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.thecoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.thecointools.com", true);
        vSeeds.emplace_back("dnsseed.thecoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.thecointools.com", true);
        vSeeds.emplace_back("seed-b.thecoinloshan.co.uk", true);
