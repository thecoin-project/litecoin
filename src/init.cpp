...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/thecoin-project/thecoin>";
    const std::string URL_WEBSITE = "<https://www.cryptothecoin.com>";
